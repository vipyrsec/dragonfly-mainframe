...
def upgrade() -> None:
    ...
    op.drop_constraint("download_urls_package_id_fkey", "download_urls", "foreignkey")
    ...
    op.drop_constraint("package_rules_package_id_fkey", "package_rules", "foreignkey")
...
def downgrade() -> None:
    ...
    op.drop_constraint("download_urls_scan_id_fkey", "download_urls", "foreignkey")
    ...
    op.drop_constraint("package_rules_scan_id_fkey", "package_rules", "foreignkey")
